...
class ScienceSector:
    ...
    def get_power_demand(self):
        ...
        rover_power = sum(
            rover.battery_capacity_kWh for rover in self.science_rovers 
    ...
    def get_state(self):
        """
        Get complete science sector state.
        
        Returns:
            dict: Complete science sector state including rovers and metrics
        """
        return {
            "science_rovers": [rover.report() for rover in self.science_rovers],
            "metrics": {
                "total_rovers": len(self.science_rovers),
                ...
                "step_science_generated": self.step_science_generated,
