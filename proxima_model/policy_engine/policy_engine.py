...
from proxima_model.policy_engine.science_policies import ScienceGrowthUtilizationPolicy
...
class PolicyEngine:
    ...
    def __init__(self, world):
        ...
        """
        self.world = world
        self._policies: List[Policy] = [DustCoverageThrottlePolicy(), ScienceGrowthUtilizationPolicy(self.world)]
