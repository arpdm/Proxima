...
logging.getLogger("proxima_model.sphere_engine.construction_sector").setLevel(logging.ERROR)
logging.getLogger("proxima_model.sphere_engine.equipment_manufacturing_sector").setLevel(logging.INFO)
